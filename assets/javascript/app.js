var topics = ["Pandas", "Puppies", "Kittens", "Penguins", "Elephants", "Seals", "Monkeys", "Cows"];
...
$(document).on("click", ".search", function() {
    ...
    var topic = $(this).text();
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + topic + "&limit=100&api_key=wPRy3VcQX606fFJctDXgLXPKWwjbLYC9";
